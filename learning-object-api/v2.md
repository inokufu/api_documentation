...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:center">Yes</td>
      <td style="text-align:left">Currently supported sorting order are <code>random</code> or <code>best</code>.
        If empty, response will be sorted by relevancy (i.e. <code>best</code>).</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:center">Yes</td>
      <td style="text-align:left">Number of LO returned per page. Value must be between 1 to 20.</td>
    </tr>
    <tr>
      ...
      <td style="text-align:center">Yes</td>
      <td style="text-align:left">The number of returned page. Value must be superior or equal to 1.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">The maximum level of the LO. The level is indicated as decimal number
        ranging from between -1 (beginner) to 1 (advanced). For example, if you
        want to see a MOOC with a level for beginner, you can set <code>levelMax=-0.5</code>.</td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">The minimum level of the LO. The level is indicated as decimal number
        comprised between -1 (beginner) and 1 (advanced). For example, if you want
        to see a MOOC with a level for intermediate or above, you can set <code>levelMin=0.2</code>.</td>
    </tr>
    <tr>
      <td style="text-align:left"><code>loPopularityMin</code>
      </td>
      <td style="text-align:center"></td>
      <td style="text-align:center">No</td>
      <td style="text-align:left">loPopularity is an indicator of the popularity of the LO as measured by
        its likes, stars, views, etc. This parameter enables you to set a threshold
        to filter out LO below a certain loPopularity. This value ranges from 0
        (low popularity) to 1 (exceptionally popular).</td>
    </tr>
  </tbody>
</table>
