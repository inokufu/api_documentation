...
This endpoint returns a list of learning objects \(LO\) that matches specific keywords and various other criteria. 
...
This endpoint return a list of the languages currently supported by the API. 
...
This endpoint return a list of the types currently supported by the API.
...
| formation | MonCompteFormation, Pôle Emploi |
| safety sheet | Google play store, App store |
| tutorial | WikiHow, Instructables |
| website | Investopedia, Stack overflow |
...
This endpoint return a list of the [Bloom objectives](https://en.wikipedia.org/wiki/Bloom%27s_taxonomy) currently supported by the API.
...
This endpoint return a list of the major providers currently supported by the API.
