...
{% hint style="info" %}
You can adjust how strict you want the results to match your query. The API offers two parameters for this purpose: `match` and `model`. `match` is used to indicate how stricly you want the results to match your query parameters (excluding `keywords`parameter). `model`is used to indicate how strictly you want the results to match the `keywords`parameter. All parameters are detailled here-after. 
{% endhint %}
